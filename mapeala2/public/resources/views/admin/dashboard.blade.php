    ...
    <table class="table table-hover table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $d->contact }}</td>
          <td>
            <a href="admin/hospital/edit/{{ $d->id }}" class="btn btn-info btn-sm">Edit</a>
            <a onclick="return confirm('Are you sure to delete this?')" href="admin/hospital/delete/{{ $d->id }}" class="btn btn-danger btn-sm">Delete</a>
          </td>
        </tr>
        @endforeach
        <tr>
